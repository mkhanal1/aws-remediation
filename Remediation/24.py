...
Usage: This module will enable access logging for the affected CloudTrail buckets. The logging bucket will be named "s3sccesslogs-regionaccountId"
...
def action(boto_session,query,resourceId,region_name,accountId):
    ...
    bucket_name = query[0]['actualValue']
    print ("Trail {}:Bucket {}".format(resourceId,bucket_name))
