...
Usage: This module will disable public accessibility of the affected RDS.
...
def action(boto_session,query,resourceId,region_name,accountId):
    ...
    try:
        ...
        if status_code > 400:
            debug_module.append("Public Visibility settings could not be removed!")
            debug_module.append(str(response))
        else:
            debug_module.append("Public Visibility settings removed successfully")
